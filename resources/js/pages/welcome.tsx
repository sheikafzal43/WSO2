                        ...
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        href="/donate"
                                        className="inline-block rounded-sm border border-blue-600 bg-blue-600 px-5 py-1.5 text-sm leading-normal text-white hover:border-blue-700 hover:bg-blue-700"
                                    >
                                        Make a Donation
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href="/admin/login"
                                        className="inline-block rounded-sm border border-gray-300 bg-white px-5 py-1.5 text-sm leading-normal text-gray-700 hover:border-gray-400 hover:bg-gray-50"
                                    >
                                        Admin Login
                                    </a>
                                </li>
